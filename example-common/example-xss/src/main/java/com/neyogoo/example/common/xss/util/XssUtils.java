package com.neyogoo.example.common.xss.util;
...
public class XssUtils {
    ...
    private static final Pattern SCRIPT_BETWEEN_PATTERN =
            Pattern.compile("<[\r\n| | ]*script[\r\n| | ]*>(.*?)</[\r\n| | ]*script[\r\n| | ]*>",
    ...
    private static final Pattern EVAL_PATTERN =
            Pattern.compile("eval\\((.*?)\\)", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    private static final Pattern E_XPRESSION_PATTERN =
            Pattern.compile("e-xpression\\((.*?)\\)", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    private static final Pattern MOCHA_PATTERN =
            Pattern.compile("mocha[\r\n| | ]*:[\r\n| | ]*", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    ...
    private static final Pattern ONMOUSEOVER_PATTERN =
            Pattern.compile("onMouseOver=.*?//", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    private static final Pattern ONMOUSEOVER_PATTERN_2 =
            Pattern.compile("onmouseover(.*)", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    private static final Pattern ONMOUSEOVER_PATTERN_3 =
            Pattern.compile("onmouseover=.*?", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE
                    | Pattern.DOTALL);
    ...
    public static String stripXssAndSql(String value) {
        ...
        value = SCRIPT_BETWEEN_PATTERN.matcher(value).replaceAll(replaceString);
        // Remove any lonesome </script> tag
        value = SCRIPT_END_PATTERN.matcher(value).replaceAll(replaceString);
        // Remove any lonesome <script ...> tag
        value = SCRIPT_START_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid eval(...) expressions
        value = EVAL_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid e-xpression(...) expressions
        value = E_XPRESSION_PATTERN.matcher(value).replaceAll(replaceString);
        value = MOCHA_PATTERN.matcher(value).replaceAll(replaceString);
        value = EXPRESSION_PATTERN.matcher(value).replaceAll(replaceString);
        value = URL_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid vbscript:... expressions
        value = VBSCRIPT_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid javascript:... expressions
        value = JAVASCRIPT_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid onload= expressions
        value = ONLOAD_PATTERN.matcher(value).replaceAll(replaceString);
        // Avoid onMouseOver= expressions
        value = ONMOUSEOVER_PATTERN.matcher(value).replaceAll(replaceString);
        value = ONMOUSEOVER_PATTERN_2.matcher(value).replaceAll(replaceString);
        value = ONMOUSEOVER_PATTERN_3.matcher(value).replaceAll(replaceString);
        value = ALERT_PATTERN.matcher(value).replaceAll(replaceString);
