...
import com.neyogoo.example.common.cloud.http.InfoFeignLoggerFactory;
import com.neyogoo.example.common.cloud.http.RestTemplateHeaderInterceptor;
import feign.Logger;
...
public class RestTemplateConfiguration {
    ...
    /**
     * 解决 RestTemplate 传递 Request header
     */
    @Bean
