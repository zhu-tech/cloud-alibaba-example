...
public final class ArgumentAssert {
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) throws ArgumentException {
        isTrue(expression, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params) throws ArgumentException {
        isFalse(expression, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static void isNull(Object object, String errorMsgTemplate, Object... params) throws ArgumentException {
        isNull(object, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出{@link ArgumentException}
    ...
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws ArgumentException {
        return notNull(object, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params)
        ...
        return notEmpty(text, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notEmpty(T text) throws ArgumentException {
        return notEmpty(text, "[Assertion failed] - "
    ...
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params)
            throws ArgumentException {
        return notBlank(text, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notBlank(T text) throws ArgumentException {
        return notBlank(text, "[Assertion failed] - this String argument must have text; "
    ...
    public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params)
        ...
        return notContain(textToSearch, substring,
                () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static String notContain(String textToSearch, String substring) throws ArgumentException {
        return notContain(textToSearch, substring, "[Assertion failed] - "
     ...
     * @throws ArgumentException 非子串抛出异常
     */
    public static <T> T contain(Collection<T> collection, T item, String errorMsgTemplate, Object... params)
            throws ArgumentException {
        return contain(
                collection, item,
                () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params))
     ...
     * @throws ArgumentException 非子串抛出异常
     */
    public static <T, X extends Throwable> T contain(Collection<T> collection, T item, Supplier<X> errorSupplier)
            throws X {
     ...
     * @throws ArgumentException 非子串抛出异常
     */
    public static <T> T notContain(Collection<T> collection, T item, String errorMsgTemplate, Object... params)
            throws ArgumentException {
     ...
     * @throws ArgumentException 非子串抛出异常
     */
    public static <T, X extends Throwable> T notContain(Collection<T> collection, T item, Supplier<X> errorSupplier)
            throws X {
        if (CollUtil.contains(collection, item)) {
            throw errorSupplier.get();
        }
    ...
    public static <T> T[] notEmpty(T[] array, String errorMsgTemplate, Object... params) throws ArgumentException {
        return notEmpty(array, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] notEmpty(T[] array) throws ArgumentException {
        return notEmpty(array, "[Assertion failed] - "
    ...
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params)
            throws ArgumentException {
        return noNullElements(array, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <E, T extends Iterable<E>> T notEmpty(T collection, String errorMsgTemplate, Object... params)
            throws ArgumentException {
        return notEmpty(collection, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <E, T extends Iterable<E>> T notEmpty(T collection) throws ArgumentException {
        return notEmpty(collection, "[Assertion failed] - "
    ...
    public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params)
            throws ArgumentException {
        return notEmpty(map, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
    ...
    public static <K, V, T extends Map<K, V>> T notEmpty(T map) throws ArgumentException {
        return notEmpty(map, "[Assertion failed] - "
    ...
    public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params)
        ...
        if (!type.isInstance(obj)) {
            throw new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params));
        }
        return obj;
    }
    ...
    /**
     * 检查 boolean 表达式，当检查结果为false时抛出 {@code IllegalStateException}。
     *
     * @param expression       boolean 表达式
     * @param errorMsgTemplate 异常时的消息模板
     * @param params           参数列表
    ...
    public static void state(boolean expression, String errorMsgTemplate, Object... params)
        ...
        if (!expression) {
            throw new IllegalStateException(CharSequenceUtil.format(errorMsgTemplate, params));
        }
    }
    ...
    public static int checkBetween(int value, int min, int max) {
        if (value < min || value > max) {
            throw new ArgumentException(CharSequenceUtil.format("Length must be between {} and {}.", min, max));
        }
        return value;
    }
    ...
    public static void equals(Object expected, Object actual, String errorMsgTemplate, Object... params) {
        equals(expected, actual, () -> new ArgumentException(CharSequenceUtil.format(errorMsgTemplate, params)));
    }
     ...
     * @throws X if expression is {@code false}
     */
    public static <X extends Throwable> void equals(Object expected, Object actual, Supplier<? extends X> supplier)
            throws X {
    ...
    private static String badIndexMsg(int index, int size, String desc, Object... params) {
        if (index < 0) {
            return CharSequenceUtil.format("{} ({}) must not be negative",
                    CharSequenceUtil.format(desc, params), index);
        } else if (size < 0) {
            throw new ArgumentException("negative size: " + size);
        } else {
            // index >= size
            return CharSequenceUtil.format("{} ({}) must be less than size ({})",
                    CharSequenceUtil.format(desc, params), index, size);
        }
    }
