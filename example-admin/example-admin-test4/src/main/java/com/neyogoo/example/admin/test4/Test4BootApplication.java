package com.neyogoo.example.admin.test4;
...
public class Test4BootApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(Test4BootApplication.class, args);
