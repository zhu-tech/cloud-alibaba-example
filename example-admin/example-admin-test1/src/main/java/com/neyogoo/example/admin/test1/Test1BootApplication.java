package com.neyogoo.example.admin.test1;
...
public class Test1BootApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(Test1BootApplication.class, args);
