package com.neyogoo.example.admin.test6;
...
public class Test6BootApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(Test6BootApplication.class, args);
