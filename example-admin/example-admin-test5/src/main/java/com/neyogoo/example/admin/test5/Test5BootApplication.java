package com.neyogoo.example.admin.test5;
...
public class Test5BootApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(Test5BootApplication.class, args);
